...
\eproof
 ...
 \begin{theorem}\label{cover}
 	 ...
 	 $\tilde{G}$ -invariant metric on $\tilde{M}:=\tilde{G} /
...
$$
g_{a H}(u, v):=Q\left(\left(d \tau_{a}\right)_{a
...
\eproof
\bproof
Back to theorm $\ref{cover}$. We prove that $\tilde{M}$ is a
...
\[
\begin{matrix}
	G&\stackrel{\pi}{\longrightarrow}&G/K\\
	\ \ \downarrow \sigma& &\ \ \downarrow \sigma_{0}\\
	G&\stackrel{\pi}{\longrightarrow}&G/K
\end{matrix}
\]
hence
...
$\sigma_{g \tilde{K}}:= \tau_{g} \sigma_{0} \tau_{g}^{-1}$,  it
